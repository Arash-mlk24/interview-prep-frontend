...
export const translations: Record<Language, Record<TranslationKeys, string>> = {
  en: {
    ...
    appSubtitle: "Software Engineering Mastery & Roadmaps",
    curatedKnowledge: "Curated Knowledge",
    allStacks: "All Stacks",
    homeHeroBadge: "Senior & Architect Career Ready",
    homeHeroTitle1: "Master Engineering Interviews & ",
    homeHeroTitle2: "Architectural Roadmaps",
    homeHeroSubtitle:
      "A high-performance, structured knowledge and roadmap hub for Junior, Mid-Level, Senior, and Lead engineers. Explore deep concepts, real-world internals, and architectural patterns.",
    ...
    footerCopyright: "Telos • Software Engineering Mastery & Technical Roadmaps",
    footerNote: "Deep Knowledge Base • Multi-Level Engineering Excellence",
    languageToggle: "فارسی",
  },
  fa: {
    appTitle: "تِلوس",
    appBadge: "معماری حرفه‌ای",
    appSubtitle: "مرجع جامع ارتقای مهندسی نرم‌افزار و نقشه‌های راه",
